...
export default function Plant({plant,reload,sidePanel,setForm}) {
    ...
    function editPlant(){
        ...
        setForm({
            ...
            watering: watering[plant.water_how_often],
            ...
            <div className='plant_data'>
                ...
                <div className='plant_sunlight'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-sun" viewBox="0 0 16 16">
                     ...
                     {plant.sunlight.slice(0,1).toUpperCase() + plant.sunlight.slice(1).replace('_',' ')}
                </div>
                <div className='plant_water'>
                    ...
                    {plant.water_how_often}
                </div>
                <div className='plant_last_watering'>
                ...
                <button className='plant_delete_btn' onClick={deleteItem}>
                ...
                <button onClick={editPlant}className='plant_edit_btn'>
                ...
                <button  onClick={water} className='water_btn'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-droplet" viewBox="0 0 16 16">
