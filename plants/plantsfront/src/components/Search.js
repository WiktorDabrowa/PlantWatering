        ...
        <div className="search_container">
            <div className='name_container'>
                ...
                <h1 className='page_title'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-droplet-half" viewBox="0 0 16 16">
            ...
            <button className='addRoom_btn search_btn' onClick={displayAddingRoom}>
